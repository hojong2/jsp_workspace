...
<head>
    ...
    <!-- Google Font -->
    <link href="/static/shop/https://fonts.googleapis.com/css2?family=Cookie&display=swap" rel="stylesheet">
    <link href="/static/shop/https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;800;900&display=swap"
    rel="stylesheet">
                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="/static/shop/#">Women’s</a></li>
                            <li><a href="/static/shop/#">Men’s</a></li>
                            <li><a href="/static/shop/./shop.html">Shop</a></li>
                            <li><a href="/static/shop/#">Pages</a>
                                <ul class="dropdown">
        ...
        <div class="row property__gallery">
                ...
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="/static/shop/img/product/product-1.jpg">
                        ...
                        <ul class="product__hover">
                            ...
                            <li><a href="/static/shop/#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="/static/shop/#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Buttons tweed blazer</a></h6>
                        <div class="rating">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Flowy striped skirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Cotton T-Shirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Slim striped pocket shirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Fit micro corduroy shirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Tropical Kimono</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Contrasting sunglasses</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    ...
                    <div class="product__item__text">
                        <h6><a href="/static/shop/#">Water resistant backpack</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="/static/shop/img/instagram/insta-1.jpg">
                    <div class="instagram__text">
                        ...
                        <a href="/static/shop/#">@ ashion_shop</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    ...
                    <div class="footer__payment">
                        <a href="/static/shop/#"><img src="/static/shop/img/payment/payment-1.png" alt=""></a>
                        <a href="/static/shop/#"><img src="/static/shop/img/payment/payment-2.png" alt=""></a>
                        <a href="/static/shop/#"><img src="/static/shop/img/payment/payment-3.png" alt=""></a>
                        <a href="/static/shop/#"><img src="/static/shop/img/payment/payment-4.png" alt=""></a>
                        <a href="/static/shop/#"><img src="/static/shop/img/payment/payment-5.png" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-5">
                <div class="footer__widget">
                    <h6>Quick links</h6>
                    <ul>
                        <li><a href="/static/shop/#">About</a></li>
                        <li><a href="/static/shop/#">Blogs</a></li>
                        <li><a href="/static/shop/#">Contact</a></li>
                        <li><a href="/static/shop/#">FAQ</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4">
                <div class="footer__widget">
                    <h6>Account</h6>
                    <ul>
                        <li><a href="/static/shop/#">My Account</a></li>
                        <li><a href="/static/shop/#">Orders Tracking</a></li>
                        <li><a href="/static/shop/#">Checkout</a></li>
                        <li><a href="/static/shop/#">Wishlist</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-8 col-sm-8">
                <div class="footer__newslatter">
                    ...
                    <div class="footer__social">
                        <a href="/static/shop/#"><i class="fa fa-facebook"></i></a>
                        <a href="/static/shop/#"><i class="fa fa-twitter"></i></a>
                        <a href="/static/shop/#"><i class="fa fa-youtube-play"></i></a>
                        <a href="/static/shop/#"><i class="fa fa-instagram"></i></a>
                        <a href="/static/shop/#"><i class="fa fa-pinterest"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer__copyright__text">
                    <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="/static/shop/https://colorlib.com" target="_blank">Colorlib</a></p>
                </div>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </div>
        </div>
